...
function buildSchedule() {
  ...
  function blogRow(d, pillar, keyword, isWeekday) {
    ...
    return [
      ...
      `${title} | Boxx Finance`,
      `Expert guide on ${keyword} for UK businesses. Fast, flexible funding from Boxx Finance.`,
      pillar.name,
  ...
  function locationRow(d, pillar, city, slot) {
    ...
    return [
      ...
      `${title} | Boxx Finance`,
      `${pillar.name} in ${city} for UK businesses. Fast, flexible funding from Boxx Finance.`,
      pillar.name,
