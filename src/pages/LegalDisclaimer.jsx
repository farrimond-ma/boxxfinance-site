    ...
    return (
        <div className="blog-post-page">
            <SEO
                ...
                description="Legal information for Boxx Finance. We act as a commercial finance broker, not a lender. Read our regulatory status, commission disclosure and liability terms."
            />
                ...
                <div className="blog-main">
                    <div className="blog-main-card">
                        <div className="blog-post-content" style={{ padding: '3rem' }}>
                            ...
                            <p>Boxx Finance is a commercial finance broker and not a lender. We work with a panel of lenders to find funding solutions for business purposes.</p>
