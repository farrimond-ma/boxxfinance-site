        ...
        <div className="sme-index-page">
            ...
            <div className="container">
                ...
                <div className="author-bio">
                    <img src="/andrew-farrimond.png" alt="Andrew Farrimond — Managing Partner, Boxx Commercial Finance" className="author-img" onError={(e) => { e.target.onerror = null; e.target.style.display = 'none' }} />
