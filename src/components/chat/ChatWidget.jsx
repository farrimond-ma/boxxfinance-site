...
function inferPageCategory(pathname) {
    ...
    if (/^\/ads\/stop-repossession/.test(pathname)) return 'stop repossession ad landing page (new enquiry, repossession/receivership risk, contact details not yet given)';
