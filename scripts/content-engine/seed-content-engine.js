...
const AM_BLOGS = [
  ...
  // Additional AM topics (batch 2) — takes list to 90
  { keyword: 'bridging loan barn conversion',              slug: 'bridging-loan-barn-conversion',              title: 'Bridging Finance for Barn Conversions' },
  { keyword: 'bridging loan church conversion',            slug: 'bridging-loan-church-conversion',            title: 'Bridging Loans for Church Conversion Projects' },
  { keyword: 'bridging loan office to residential',        slug: 'bridging-loan-office-to-residential',        title: 'Bridging Finance for Office-to-Residential Conversions' },
  { keyword: 'bridging loan pub conversion uk',            slug: 'bridging-loan-pub-conversion',               title: 'Bridging Loans for Pub Conversions' },
  { keyword: 'bridging loan plot with planning permission',slug: 'bridging-loan-plot-planning-permission',     title: 'Bridging Loans for Plots With Planning Permission' },
  { keyword: 'bridging loan rural property uk',            slug: 'bridging-loan-rural-property',               title: 'Bridging Finance for Rural and Countryside Properties' },
  { keyword: 'bridging loan agricultural land',            slug: 'bridging-loan-agricultural-land',            title: 'Bridging Loans for Agricultural Land Purchase' },
  { keyword: 'bridging loan equestrian property',          slug: 'bridging-loan-equestrian-property',          title: 'Bridging Finance for Equestrian and Stable Properties' },
  { keyword: 'bridging loan ex local authority property',  slug: 'bridging-loan-ex-local-authority',           title: 'Bridging Loans for Ex-Local Authority Properties' },
  { keyword: 'bridging loan high rise flat',               slug: 'bridging-loan-high-rise-flat',               title: 'Bridging Finance for High-Rise Flats' },
  { keyword: 'bridging loan basement conversion',          slug: 'bridging-loan-basement-conversion',          title: 'Bridging Loans for Basement Conversions' },
  { keyword: 'bridging loan loft conversion',              slug: 'bridging-loan-loft-conversion',              title: 'Bridging Finance for Loft Conversion Projects' },
  { keyword: 'bridging loan ground floor extension',       slug: 'bridging-loan-ground-floor-extension',       title: 'Bridging Loans to Fund a Ground Floor Extension' },
  { keyword: 'bridging loan detached annexe',              slug: 'bridging-loan-detached-annexe',              title: 'Bridging Finance for a Detached Annexe Build' },
  { keyword: 'bridging loan non standard construction',    slug: 'bridging-loan-non-standard-construction',    title: 'Bridging Loans for Non-Standard Construction Properties' },
  { keyword: 'bridging loan thatched roof property',       slug: 'bridging-loan-thatched-property',            title: 'Bridging Finance for Thatched Properties' },
  { keyword: 'bridging loan timber frame property',        slug: 'bridging-loan-timber-frame',                 title: 'Bridging Loans for Timber Frame Properties' },
  { keyword: 'bridging loan flat above commercial',        slug: 'bridging-loan-flat-above-commercial',        title: 'Bridging Finance for Flats Above Commercial Premises' },
  { keyword: 'bridging loan ground rent purchase',         slug: 'bridging-loan-ground-rent-purchase',         title: 'Bridging Loans for Ground Rent Portfolio Purchase' },
  { keyword: 'bridging loan lease extension finance',      slug: 'bridging-loan-lease-extension',              title: 'Using a Bridging Loan to Fund a Lease Extension' },
  { keyword: 'bridging loan property auction scotland',    slug: 'bridging-loan-property-auction-scotland',    title: 'Bridging Loans for Property Auctions in Scotland' },
  { keyword: 'bridging loan tenanted investment property', slug: 'bridging-loan-tenanted-property',            title: 'Bridging Finance for Tenanted Investment Properties' },
  { keyword: 'bridging loan serviced accommodation',       slug: 'bridging-loan-serviced-accommodation',       title: 'Bridging Finance for Serviced Accommodation Properties' },
  { keyword: 'bridging loan airbnb short term let',        slug: 'bridging-loan-airbnb-short-term-let',        title: 'Bridging Loans for Airbnb and Short-Term Let Properties' },
  { keyword: 'bridging loan holiday let property uk',      slug: 'bridging-loan-holiday-let-property',         title: 'Bridging Finance for Holiday Let Properties' },
  { keyword: 'bridging loan for student hmo',              slug: 'bridging-loan-student-hmo',                  title: 'Bridging Finance for Student HMO Properties' },
  { keyword: 'bridging loan care home development',        slug: 'bridging-loan-care-home-development',        title: 'Bridging Finance for Care Home Development' },
  { keyword: 'bridging loan supported living property',    slug: 'bridging-loan-supported-living',             title: 'Bridging Loans for Supported Living Properties' },
  { keyword: 'bridging loan mixed tenure development',     slug: 'bridging-loan-mixed-tenure-development',     title: 'Bridging Finance for Mixed-Tenure Development Schemes' },
  { keyword: 'bridging loan residential to commercial',    slug: 'bridging-loan-residential-to-commercial',    title: 'Bridging Loans for Residential-to-Commercial Conversion' },
];
...
const PM_BLOGS = [
  ...
  // Additional PM topics (batch 2) — takes list to 90
  { keyword: 'bridging loan when mortgage falls through',  slug: 'bridging-loan-mortgage-falls-through',       title: 'Bridging Loans When a Mortgage Falls Through' },
  { keyword: 'bridging loan for fast completion property', slug: 'bridging-loan-fast-completion',              title: 'Bridging Finance for Fast Property Completions' },
  { keyword: 'bridging loan property with japanese knotweed', slug: 'bridging-loan-japanese-knotweed',         title: 'Bridging Loans for Properties With Japanese Knotweed' },
  { keyword: 'bridging loan asbestos property',            slug: 'bridging-loan-asbestos-property',            title: 'Can You Get a Bridging Loan on a Property With Asbestos?' },
  { keyword: 'bridging loan flood risk property',          slug: 'bridging-loan-flood-risk-property',          title: 'Bridging Loans for Flood Risk Properties' },
  { keyword: 'bridging loan receivers sale uk',            slug: 'bridging-loan-receivers-sale',               title: 'Using a Bridging Loan to Buy a Receiver\'s Sale Property' },
  { keyword: 'bridging loan property in administration',   slug: 'bridging-loan-property-administration',      title: 'Bridging Finance for Properties in Administration' },
  { keyword: 'bridging loan forced sale property',         slug: 'bridging-loan-forced-sale',                  title: 'Bridging Loans for Forced Sale Properties' },
  { keyword: 'bridging loan inheritance property uk',      slug: 'bridging-loan-inheritance-property',         title: 'Using a Bridging Loan to Release Inheritance Property Value' },
  { keyword: 'bridging loan arrangement fee explained',    slug: 'bridging-loan-arrangement-fee',              title: 'Bridging Loan Arrangement Fees: What You\'ll Pay' },
  { keyword: 'bridging loan exit fee explained',           slug: 'bridging-loan-exit-fee',                     title: 'Bridging Loan Exit Fees: Are They Worth It?' },
  { keyword: 'bridging loan drawdown facility',            slug: 'bridging-loan-drawdown-facility',            title: 'Bridging Loan Drawdown Facilities Explained' },
  { keyword: 'bridging loan land without planning',        slug: 'bridging-loan-land-without-planning',        title: 'Bridging Loans for Land Without Planning Permission' },
  { keyword: 'bridging loan land planning in principle',   slug: 'bridging-loan-land-planning-in-principle',   title: 'Bridging Finance for Land With Planning in Principle' },
  { keyword: 'buy refurbish refinance bridging loan',      slug: 'buy-refurbish-refinance-bridging',           title: 'Buy, Refurbish, Refinance: How Bridging Finance Makes It Work' },
  { keyword: 'bridging loan property flip uk',             slug: 'bridging-loan-property-flip',                title: 'Bridging Finance for Property Flipping in the UK' },
  { keyword: 'bridging loan for downsizing property',      slug: 'bridging-loan-downsizing',                   title: 'Using a Bridging Loan When Downsizing' },
  { keyword: 'bridging loan for upsizing home',            slug: 'bridging-loan-upsizing',                     title: 'Bridging Finance When Upsizing to a Larger Home' },
  { keyword: 'bridging loan gifted deposit',               slug: 'bridging-loan-gifted-deposit',               title: 'Bridging Loans and Gifted Deposits: What Lenders Accept' },
  { keyword: 'bridging loan interest rate calculator uk',  slug: 'bridging-loan-interest-rate-calculator',     title: 'Bridging Loan Interest Rate Calculator Guide' },
  { keyword: 'bridging loan for vacant commercial unit',   slug: 'bridging-loan-vacant-commercial',            title: 'Bridging Finance for Vacant Commercial Units' },
  { keyword: 'bridging loan for property with sitting tenant', slug: 'bridging-loan-sitting-tenant',           title: 'Bridging Loans for Properties With a Sitting Tenant' },
  { keyword: 'bridging loan 100 percent with extra security', slug: 'bridging-loan-100-extra-security',        title: '100% Bridging Finance Using Additional Property Security' },
  { keyword: 'bridging loan international buyer uk',       slug: 'bridging-loan-international-buyer',         title: 'Bridging Loans for International Buyers in the UK' },
  { keyword: 'bridging loan how to apply guide',           slug: 'bridging-loan-how-to-apply',                 title: 'How to Apply for a Bridging Loan: A Step-by-Step Guide' },
  { keyword: 'bridging loan credit history uk lenders',    slug: 'bridging-loan-credit-history-lenders',       title: 'How UK Bridging Lenders Assess Your Credit History' },
  { keyword: 'bridging loan for property development exit',slug: 'bridging-loan-development-exit',             title: 'Development Exit Bridging Finance Explained' },
  { keyword: 'bridging loan for pension age borrower',     slug: 'bridging-loan-pension-age-borrower',         title: 'Bridging Loans for Borrowers of Pension Age' },
  { keyword: 'bridging loan case study examples uk',       slug: 'bridging-loan-case-study-examples',          title: 'UK Bridging Loan Case Studies: Real Examples Explained' },
  { keyword: 'bridging loan glossary terms explained',     slug: 'bridging-loan-glossary',                     title: 'Bridging Finance Glossary: Key Terms Every Borrower Should Know' },
];
