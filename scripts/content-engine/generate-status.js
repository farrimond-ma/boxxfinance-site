...
const DAILY_ACTIONS = [
  ...
  { id: 'linkedin',   label: 'LinkedIn post',                workflow: 'publish-linkedin.yml',
    commitPattern: /^social: linkedin posted for (.+)$/, days: 'weekdays',
    evidenceNote: 'LinkedIn API confirmed the post at publish time (read-back not permitted by LinkedIn scopes)' },
  { id: 'instagram',  label: 'Instagram post',               workflow: 'publish-instagram.yml',
    commitPattern: /^social: instagram posted for (.+)$/, platformCheck: 'instagram', days: 'weekdays' },
  { id: 'reel',       label: 'Facebook Reel video',          workflow: 'publish-facebook-reels.yml',
    commitPattern: /^social: reel posted for (.+)$/, platformCheck: 'reels', days: 'weekdays' },
  { id: 'pinterest',  label: 'Pinterest pin',                workflow: 'publish-pinterest.yml',
    commitPattern: /^social: pinterest posted for (.+)$/, days: 'weekdays' },
