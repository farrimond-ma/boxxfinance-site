...
Open with exactly this sentence: "The example below is illustrative — a composite reflecting the shape of deals of this kind, not a specific, identifiable transaction." Then ONE example about a homeowner, landlord, or property investor — NOT a business — framed explicitly as hypothetical: "Consider a ${city}-based [homeowner / landlord / property investor] who needs..." NOT "Recently, we helped..." or any other phrasing that claims this is a real, specific, previously-completed Boxx case. Include a realistic loan amount, the challenge (chain break, auction deadline, refurbishment), what would be arranged, and the likely outcome. 1 solid paragraph.
